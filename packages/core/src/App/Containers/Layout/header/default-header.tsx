                        ...
                        <React.Fragment>
                            ...
                            <div className='header__left-stack'>
                                ...
                                <div className='header__socials'>
                                    <a href='https://wa.me/+254794060465' target='_blank' rel='noopener noreferrer' aria-label='Facebook'>
                                        <Icon icon='IcFacebook' width={20} height={20} />
                                    </a>
                                    <a href='https://wa.me/+254794060465' target='_blank' rel='noopener noreferrer' aria-label='WhatsApp'>
                                        <Icon icon='IcWhatsappFilled' width={20} height={20} />
                                    </a>
                                    <a href='https://t.me/+DsTvV3FwvWhiN2E0' target='_blank' rel='noopener noreferrer' aria-label='Telegram'>
